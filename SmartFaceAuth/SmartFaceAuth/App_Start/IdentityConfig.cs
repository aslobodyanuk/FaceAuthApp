...
namespace SmartFaceAuth
{
    ...
    public class ApplicationSignInManager : SignInManager<ApplicationUser, string>
    {
        ...
        public async Task<SignInStatus> SignInFace(string inputEmail, bool rememberMe)
        {
            ApplicationUser user = await HttpContext.Current.GetOwinContext()
                .GetUserManager<ApplicationUserManager>()
                .FindByEmailAsync(inputEmail);
            if (user != null)
            {
